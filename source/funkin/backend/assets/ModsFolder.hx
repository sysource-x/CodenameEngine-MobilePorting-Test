...
class ModsFolder {
	 ...
	 */
	public static var modsPath:String = #if mobile StorageUtil.getStorageDirectory() + #end "mods/";
	/**
	 * Path to the `addons` folder.
	 */
	public static var addonsPath:String = #if mobile StorageUtil.getStorageDirectory() + #end "addons/";
